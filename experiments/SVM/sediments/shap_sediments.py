...
# Loading a soil spectral dataset based on X-ray fluorescence (XRF)#Loading a soil spectral dataset based on X-ray fluorescence (XRF)
...
svm_model = svm_optimized(Xcalclass_prep, ycalclass, Xpredclass_prep, ypredclass, aim='classification', kernel='rbf', random_state=42)
